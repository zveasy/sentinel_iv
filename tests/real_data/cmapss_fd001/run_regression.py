...
from hb.adapters import cmapss_fd001  # noqa: E402
...
def main():
    parser = argparse.ArgumentParser(description="CMAPSS FD001 regression harness")
    parser.add_argument(
        "--manifest",
    ...
    train_file = os.path.join(root, dataset.get("files", {}).get("train", "train_FD001.txt"))
    ...
    for window in windows:
        ...
        try:
            raw = cmapss_fd001.parse(temp_path)
